...
//        setStyle();
    ...
    private void setStyle() {
        this.setTextColor(getResources().getColor(R.color.text_gray_color));
        this.setHintTextColor(getResources().getColor(R.color.text_hint_color));
        this.setTextSize(16);
        this.setMaxLines(1);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP) {
            if (getCompoundDrawables()[2] != null) {
                ...
                if (touchable) {
                    this.setText("");
                    if (listener != null) listener.onClean(this);
                }
            }
        }
    ...
    public void setListener(ClearEditTextListener listener) {
    ...
    public static interface ClearEditTextListener {
        public void onClean(EditText et);
    }
}
